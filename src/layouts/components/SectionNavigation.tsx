...
// Minimalist outline icons (Heroicons style). Single stroke, currentColor,
// so they stay monochrome and inherit the nav's green theme colors.
              ...
              <li key={section.id}>
                ...
                >
                  {ICONS[section.id] ?? (
                    <span
                      aria-hidden="true"
                      className={`h-2 w-2 rounded-full flex-shrink-0 ${active ? 'bg-[#2d5a3d]' : 'bg-[#c8dcc8]'}`}
                    />
                  )}
